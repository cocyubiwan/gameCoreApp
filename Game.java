...
public class Game extends Canvas implements KeyListener {
	...
	public Game() {
		...
		try {
			URL url = Thread.currentThread().getContextClassLoader().getResource("441.png");
			if (url == null) {
				System.err.println("Unable to find sprite: 441.png");
				System.exit(0);
			}
			sprite = ImageIO.read(url);
		} catch (IOException e) {
			System.err.println("Unable to load sprite: 441.png");
			System.exit(0);
		}
		...
		Frame frame = new Frame("COC YuBiWan");
