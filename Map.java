			...
			for (int y=0;y<HEIGHT;y++) {
				...
				if (data[x][y] == BLOCKED) {
					g.setColor(Color.GRAY);
                                ...
                                BufferedImage img1 = null, img2 = null, img3 = null,img4=null;

                                try{
                                img3 = ImageIO.read(new File("a1.png"));
                                g.drawImage(img3, 205, 230, null);

                                img3 = ImageIO.read(new File("dd.png"));
                                g.drawImage(img3, 15, 70, null);

                                img2 = ImageIO.read(new File("Builders-Hut.png"));
                                g.drawImage(img2, 105, 70, null);

                                img1 = ImageIO.read(new File("ss.png"));
                                g.drawImage(img1, 105, 200, null);
